...
KEEP.initUtils = () => {
  ...
  KEEP.utils = {
    ...
    tocContentContainerDom: document.querySelector('.toc-content-container'),
    ...
    styleHandleWhenScroll() {
      ...
      if (this.isHasScrollProgressBar) {
        ...
        if(this.back2TopButton_dom !== null){
          if (ProgressPercent < 30 ) {
            this.back2TopButton_dom.style.visibility = 'hidden';
          } else {
            this.back2TopButton_dom.style.visibility = 'visible';
          }
        }
      }
      ...
      if (scrollTop > this.prevScrollValue && scrollTop > this.innerHeight) {
        ...
        if(this.tocContentContainerDom) {
          this.tocContentContainerDom.classList.add('tocTopTrans')
        }
      } else {
        this.pageTop_dom.classList.remove('hide');
        if(this.tocContentContainerDom) {
          this.tocContentContainerDom.classList.remove('tocTopTrans')
        }
      }
